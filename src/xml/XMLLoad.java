...
public class XMLLoad {
	...
	/*public static HashMap loadObjectTypes(String filename) throws Exception
	{
	...
	{
		ArrayList<RectTerrain> list = new ArrayList<RectTerrain>();
	...
	/*public static ArrayList loadObjects(String filename) throws Exception
	{
